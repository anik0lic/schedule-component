...
//        System.out.println(startDate + " " + endDate);
    ...
    private List<String> check(long diffDays, LocalDate sd, LocalDate ed, LocalTime startTime, LocalTime endTime, List<Appointment> appointments, List<Places> places, String day){
        int i = 0, j = 0, k = 0;
